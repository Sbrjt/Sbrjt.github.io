	...
	return (
		<BackgroundBeamsWithCollision className='bg-black'>
			<div className='text-center flex flex-col justify-center items-center z-20 md:gap-20 gap-14'>
				<div
					className='md:text-6xl text-3xl bg-clip-text text-transparent bg-gradient-to-b from-slate-200 to-slate-600 font-bold pb-1 md:pb-3'
					id='Contact'
				>
					Let's get in touch :)
				</div>
				...
				<div className='flex flex-col md:flex-row justify-center items-center gap-8 md:gap-4 md:text-2xl text-lg w-full'>
					<a href='mailto:champa.281982@gmail.com' className='w-full md:w-50'>
						<ShimmerBtn className='inline-flex gap-3 items-center justify-center w-full py-4 tracking-wider'>
							Email <FaPaperPlane />
						</ShimmerBtn>
					</a>
					<a href='https://sbrjt.github.io/resume/' className='w-full md:w-50'>
						<ShimmerBtn className='inline-flex gap-3 items-center justify-center w-full py-4 tracking-wider'>
