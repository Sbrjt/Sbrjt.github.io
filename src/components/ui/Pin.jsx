...
const PinPerspective = ({ title, href }) => {
	return (
		<motion.div className='w-[80vw] md:w-150 h-80 items-center justify-center opacity-0 group-hover/pin:opacity-100 z-[60] transition duration-500 hidden md:flex'>
